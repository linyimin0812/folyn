...
<h1 align="center">Editor Quill</h1>
...
- **Vista previa universal** — Documentos de Office, audio/vídeo, archivos comprimidos, libros electrónicos, presentaciones y planos — visualízalos sin salir de Quill.
...
- **Terminal integrada** — Abre una terminal dentro de Quill y deja que Claude Code / Codex / otros agentes CLI lean y escriban el documento actual — sin cambiar de ventana.
...
Visualiza documentos de Office, audio/vídeo, archivos comprimidos, libros electrónicos, presentaciones y planos sin salir de Quill — no hace falta software adicional.
...
Abre un panel de terminal en el espacio de trabajo de Quill, junto al editor, con rutas de archivo sincronizadas automáticamente. Claude Code / Codex CLI / otros agentes pueden modificar el documento actual directamente; las ediciones de IA aparecen en el editor al instante. La salida de comandos se puede re-pegar en el cursor — “editar → invocar → re-pegar” se comprime en un solo flujo.
...
- **`create-quill-plugin`** — CLI de scaffolding para iniciar rápidamente un nuevo plugin
