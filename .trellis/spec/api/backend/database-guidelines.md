...
**Not applicable.** Mochi is a local-first Markdown editor with no database.

All persistence is handled by:
- **Filesystem** — Markdown files stored in the vault directory (via `@mochi/vault-provider`)
