...
> Guidelines for the @folyn/container-plugins package.

---

## Overview

`@folyn/container-plugins` provides a registry-based plugin system for Markdown container directives (`:::callout`, `:::tabs`, etc.). Plugins render in the preview pane and appear in the editor's `/` slash command menu.
