...
Der Folyn-Desktop-Begleiter betreibt zur Laufzeit einen **nur auf 127.0.0.1** lauschenden HTTP-Dienst. Externe Apps
...
```bash
curl -XPOST 127.0.0.1:17382/pet/action \
  -d '{"action":"notify","text":"CI fehlgeschlagen","source":"github","template":"glass","data":{"repo":"folyn","runId":42}}'
```
