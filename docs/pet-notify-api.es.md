...
La mascota de escritorio de Quill arranca un servicio HTTP **solo en 127.0.0.1** en tiempo de ejecución. Las apps externas
...
```bash
curl -XPOST 127.0.0.1:17382/pet/action \
  -d '{"action":"notify","text":"CI falló","source":"github","template":"glass","data":{"repo":"quill","runId":42}}'
```
