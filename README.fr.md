...
<h1 align="center">Éditeur Mochi</h1>
...
- **Prévisualisation universelle** — Documents Office, audio/vidéo, archives, livres électroniques, présentations et plans — visualisez sans quitter Mochi.
...
- **Terminal intégré** — Ouvrez un terminal dans Mochi et laissez Claude Code / Codex / autres agents CLI lire et écrire le document courant — pas de changement de fenêtre.
...
Visualisez documents Office, audio/vidéo, archives, livres électroniques, présentations et plans sans quitter Mochi — aucun logiciel supplémentaire requis.
...
- **`create-mochi-plugin`** — CLI de scaffolding pour démarrer rapidement un nouveau plugin
