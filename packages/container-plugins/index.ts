...
export { PlantUmlBlock } from './src/plugins/PlantUmlPlugin';
...
export { stepsPlugin, stepPlugin } from './src/plugins/StepsPlugin';
...
import { stepsPlugin, stepPlugin } from './src/plugins/StepsPlugin';
