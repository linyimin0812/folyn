...
/// Localized label keys for the macOS app menu bar submenus. "Folyn" is a
...
///
/// Fullscreen detection here is best-effort: it only covers the Folyn main
...
pub(crate) const TRAY_ID: &str = "folyn-tray";
