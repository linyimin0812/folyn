  ...
  return (
    <div className="max-w-[720px]">
      ...
      <label className="block border-t border-brd pt-4">
        ...
        <input
          className="w-full max-w-[360px] text-[13px] bg-panel border border-brd2 rounded-md px-3 py-1.5 text-t1 outline-none transition-[border-color] duration-100 focus:border-acc"
