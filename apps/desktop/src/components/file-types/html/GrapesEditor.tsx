  ...
  return (
    <div className="flex-1 flex overflow-hidden bg-panel">
      ...
      <div className="flex-1 flex flex-col overflow-hidden bg-surf2">
        <div ref={containerRef} className="flex-1 overflow-hidden folyn-grapes-root" />
      </div>
      ...
      <div
        className={`w-[260px] shrink-0 border-l border-brd bg-panel overflow-hidden folyn-grapes-root ${
      ...
      >
        ...
        <div
          ref={selectorsRef}
          className={`shrink-0 border-b border-brd max-h-[120px] overflow-y-auto folyn-no-scrollbar ${
            activeTab === 'styles' ? 'block' : 'hidden'
          }`}
        />
        <div className="flex-1 overflow-y-auto folyn-no-scrollbar">
