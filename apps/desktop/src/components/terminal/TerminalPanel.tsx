...
export function TerminalPanel({
  ...
  return (
    <div
      ...
      style={{ height }}
    >
      <div className="flex items-center gap-1 h-[27px] shrink-0 px-2 bg-panel border-b border-brd overflow-hidden [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        <div className="self-stretch flex-1 min-w-0 flex items-center overflow-x-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          {sessions.map((s) => (
            <div
              key={s.id}
              className={`group relative h-full px-2 rounded-[6px] text-[13px] leading-none font-mono cursor-pointer whitespace-nowrap shrink-0 transition-colors duration-150 select-none ${
                s.id === activeId
                  ? 'bg-surf2 text-t1'
          ...
          <button
            className="shrink-0 w-[24px] h-full flex items-center justify-center rounded-[5px] text-t3 border-none bg-transparent cursor-pointer transition-colors duration-150 hover:bg-hov hover:text-t1"
        ...
        <div className="shrink-0 flex items-center justify-end">
          <button
            className="shrink-0 w-[26px] h-full flex items-center justify-center rounded-[5px] text-t3 border-none bg-transparent cursor-pointer transition-colors duration-150 hover:bg-hov hover:text-t1"
