...
1. **Clone the repository**: Use Bash to run \`git clone --depth 1 <repo_url> /tmp/folyn-repo-<reponame>\` to clone the repo locally
...
4. **Clean up**: Use Bash to remove the cloned repo directory \`rm -rf /tmp/folyn-repo-<reponame>\`
